...
function RiggerRules(){
  return (
    <Main className="bg-info">
      ...
      <p>If you are using a direct connection and already plugged into the vehcile or RCC then you can jump directly via a Simple Action.</p>
      <p>Vehicle actions are considered matrix actions while jumped in, so any bonuses to matrix actions are also bonuses to Vehcile Control Tests, Gunnery Tests, and Sensor Tests.</p>
      ...
      <p>Cold Sim VR Jumped In:
        <ul>
          ...
          <li>Control Rig Rating is added to the Vehicle Limits: (Sensor, Speed, Handling, and Accuracy for mounted weapons)</li>
          <li>Control Rig Rating in extra device to Vehicle Skill Tests</li>
          <li>Control Rig Rating reduces the Threshold for Vehicle Tests to a minimum of 1</li>
          <li>Treat vehicle actions as Matrix actions: (Vehcile Control Tests, Gunnery Tests, and Sensor Tests)</li>
