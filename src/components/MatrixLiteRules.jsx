  ...
  return (
    <Main>
      ...
      <TextSection className="bg-info">
        <p>Matrix Lite Rules by <a href="https://www.reddit.com/user/LeVentNoir/" className="text-dark">LaVentNoir</a> - <a href="https://www.reddit.com/r/Shadowrun/comments/7nhmcr/lite_matrix_rules/" className="text-dark">Source Link</a></p>
